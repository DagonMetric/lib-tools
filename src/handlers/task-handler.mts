...
import { dashToCamelCase } from '../utils/dash-to-camel-case.mjs';
import { Logger, LoggerBase } from '../utils/logger.mjs';
import { findUp, normalizePathToPOSIXStyle } from '../utils/path-helpers.mjs';
...
import { build } from './internals/build/index.mjs';
import { exec } from './internals/exec.mjs';
        ...
        try {
            ...
            if (task.taskCategory === 'build') {
                ...
                if (handlerStr.toLocaleLowerCase().startsWith('exec:')) {
                    ...
                    const taskNameCamelCase = dashToCamelCase(task.taskName);
